package br.com.jc.estruturadados.listasligadas;
...
public class ListaLigada<T> {
	...
	public void inserirEm(int posicao, T elemento) {
		if (posicao >= tamanho()) {
			throw new IllegalArgumentException(String.format("Posiçao [%d] é inválida", posicao));
		}
		if (posicao == 0) {
			No<T> novoNo = new No<T>(elemento);
	...
	public void inserirEmPrimeiro(T elemento) {
		inserirEm(0, elemento);
	}

	public void inserirEmUltimo(T elemento) {
	...
	public void remover(int posicao) {
		...
		if (posicao == 0) {
			No<T> proximo = this.primeiroNo.getProximo();
			this.primeiroNo.setProximo(null);
			this.primeiroNo = proximo;
	...
	public String toString() {
		if (estaVazia()) {
			...
			builder.append(noAtual.getElemento() != null ? noAtual.getElemento().toString() : "<NULO>");
			builder.append(",");
			while (noAtual.getProximo() != null) {
				builder.append(
						noAtual.getProximo().getElemento() != null ? noAtual.getProximo().getElemento().toString()
								: "<NULO>");
				builder.append(",");
